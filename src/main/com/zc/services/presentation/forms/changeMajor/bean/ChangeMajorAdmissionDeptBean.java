 ...
 *
 */
@ManagedBean(name="ChangeMajorAdmissionDeptBean")
@ViewScoped
public class ChangeMajorAdmissionDeptBean {

	@ManagedProperty("#{ChangeMajorAdmissionDeptFacadeImpl}")
	private IChangeMajorAdmissionDeptFacade facade;
	...
	public IChangeMajorAdmissionDeptFacade getFacade() {
		return facade;
	}
	public void setFacade(IChangeMajorAdmissionDeptFacade facade) {
		this.facade = facade;
	}
