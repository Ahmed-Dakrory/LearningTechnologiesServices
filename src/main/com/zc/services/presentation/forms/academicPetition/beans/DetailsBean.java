 ...
 *
 */
@ManagedBean(name="DetailsBeanAcademicPetition")
@ViewScoped
public class DetailsBean {
	...
	private IAcademicPetitionActionsFacade facade;
	...
	private IAdmissionAdminAcademicPetFacade adminFacade;
    
    @ManagedProperty("#{GetLoggedInStudentDataFacadeImpl}")
    private IGetLoggedInStudentDataFacade studentDataFacade;
    
    
    private CoursePetitionDTO detailedDTO;
	...
	public void fillInstructorsLst()
	 ...
	 public void approveIns()
	 {
		 Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
	    	...
	    	try{
	    	CoursePetitionDTO dto=getDetailedDTO();
	    		    	...
	    		    	if(dto!=null)
	    		    	{
	    		    		...
	    		    		try {
	    		    			if(casesID.equals("AdmissionH"))
	    		 					...
	    		 					("admissionHAcademicPet.xhtml?id="+dto.getId());
	    		    			else if(casesID.equals("ins"))
	    		 					FacesContext.getCurrentInstance().getExternalContext().redirect
	    		 					("InstructorCoursePetitionPage.xhtml?id="+dto.getId());
	    		 					JavaScriptMessagesHandler.RegisterNotificationMessage(null, "Approved successfully");
	    		 				} catch (IOException e) {
	    		...
	    		if(actionExistBefore)
		    	{
	    					...
	    					dto.getActionDTO().get(index).getActionType().equals(PetitionActionTypeEnum.REVERT)||dto.getReverted()==true)
	    			{
	    		    	...
	    		    	if(dto!=null)
	    		    	{
	    		    		...
	    		    		try {
	    		 					FacesContext.getCurrentInstance().getExternalContext().redirect
	    		 					("deanCoursePetitionPage.xhtml?id="+dto.getId());
	    		 					JavaScriptMessagesHandler.RegisterNotificationMessage(null, "Approved successfully");
	    		 				} catch (IOException e) {
	    		 					// TODO Auto-generated catch block
	    		 					e.printStackTrace();
	    		...
	    		if(actionExistBefore)
		    	{
	    					...
	    					dto.getActionDTO().get(index).getActionType().equals(PetitionActionTypeEnum.REVERT)||dto.getReverted()==true)
	    			{
	    		    	...
	    		    	if(dto!=null)
	    		    	{
	    		    		...
	    		    		try {
	    		 					FacesContext.getCurrentInstance().getExternalContext().redirect
	    		 					("admissionHAcademicPet.xhtml?id="+dto.getId()+"&action=approve");
	    		 					JavaScriptMessagesHandler.RegisterNotificationMessage(null, "Approved successfully");
	    		 				} catch (IOException e) {
	    		 					// TODO Auto-generated catch block
	    		 					e.printStackTrace();
	    		...
	    		if(actionExistBefore)
		    	{
	    					...
	    					dto.getActionDTO().get(index).getActionType().equals(PetitionActionTypeEnum.REVERT)||dto.getReverted()==true)
	    			{
	    		    	...
	    		    	if(dto!=null)
	    		    	{
	    		    		...
	    		    		try {
	    		 					FacesContext.getCurrentInstance().getExternalContext().redirect
	    		 					("admissionHAcademicPet.xhtml?id="+dto.getId()+"&action=refuse");
	    		 					JavaScriptMessagesHandler.RegisterNotificationMessage(null, "Refused successfully");
	    		 				} catch (IOException e) {
	    		 					// TODO Auto-generated catch block
	    		 					e.printStackTrace();
	 ...
	 public void markAsDone()
	 {
			...
			if(refusedByAdmissionDept)
			{
				...
				if(existed){
    		    	...
    		    	if(dto!=null)
    		    	{
    		    		...
    		    		try {
    		 					FacesContext.getCurrentInstance().getExternalContext().redirect
    		 					("admissionDAcademicPet.xhtml?id="+dto.getId());
    		 					JavaScriptMessagesHandler.RegisterNotificationMessage(null, "refused successfully");
    		 				} catch (IOException e) {
    		 					// TODO Auto-generated catch block
    		 					e.printStackTrace();
	    	...
	    	if(dto!=null)
	    	{
	    	 	init();
	    	 	FacesContext.getCurrentInstance().getExternalContext().redirect
				("admissionDAcademicPet.xhtml?id="+dto.getId()+"&action=approve");
	 ...
	 public void cancel()
		{
	         ...
	         case "Ins":  //Approve Of Instructor
	        		try {
	        			FacesContext.getCurrentInstance().getExternalContext().redirect
	        			("InstructorCoursePetitionPage.xhtml?faces-redirect=true");
	        		} catch (IOException e) {
	        			// TODO Auto-generated catch block
	        			e.printStackTrace();
	        		}
	         ...
	         case "Dean": 
	        		try {
	        			FacesContext.getCurrentInstance().getExternalContext().redirect
	        			("deanCoursePetitionPage.xhtml?faces-redirect=true");
	        		} catch (IOException e) {
	        			// TODO Auto-generated catch block
	        			e.printStackTrace();
	        		}
	         ...
	         case "AdmissionH":  
	        		try {
	        			FacesContext.getCurrentInstance().getExternalContext().redirect
	        			("admissionHAcademicPet.xhtml?faces-redirect=true");
	        		} catch (IOException e) {
	        			// TODO Auto-generated catch block
	        			e.printStackTrace();
	        		}
	         ...
	         case "AdmissionD":  
	        		try {
	        			FacesContext.getCurrentInstance().getExternalContext().redirect
	        			("admissionDAcademicPet.xhtml?faces-redirect=true");
	        		} catch (IOException e) {
	        			// TODO Auto-generated catch block
	        			e.printStackTrace();
	        		}
	         case "Stduent":  
	        		try {
	        			FacesContext.getCurrentInstance().getExternalContext().redirect
	        			("studentCoursePetitionPage.xhtml?faces-redirect=true");
	        		} catch (IOException e) {
	        			// TODO Auto-generated catch block
	        			e.printStackTrace();
	        		}
	         case "Admin":  
	        		try {
	        			FacesContext.getCurrentInstance().getExternalContext().redirect
	        			("admissionAcademicPetAdmin.xhtml?faces-redirect=true");
	        		} catch (IOException e) {
	        			// TODO Auto-generated catch block
	        			e.printStackTrace();
	        		}
			    		...
			    		if(dto!=null)
			    		{
			    			...
			    			for(int i=0;i<instructors.size();i++)
			    			{
			    				if(instructors.get(i).getId().equals(getSelectedInstructor()))
			    				{
			    					...
			    					try {
					 					FacesContext.getCurrentInstance().getExternalContext().redirect
					 					("InstructorCoursePetitionPage.xhtml?forwaredIns="+dto.getForwardTOIns().getId());
					 					break;
	 ...
	 public void addComment(CoursePetitionDTO dto) {
			try {
				if (newComment == null || newComment.equals("")) {
	 ...
	 public void sendCommentEmail(){
		 try{
				...
				stundet=studentDataFacade.getPersonByPersonMail(getDetailedDTO().getStudentMail());
				//sender.add("oalaaeddin@zewailcity.edu.eg");
				sender.add(getDetailedDTO().getStudentMail());
				SendMailThread sendMailThread = new SendMailThread(
						sender, stundet.getNameInEng(),
						email, "Academic Petition - new comment");
		    		    	...
		    		    	if(dto!=null)
		    		    	{
		    		    		...
		    		    		try {
		    		    			if(casesID.equals("AdmissionH"))
		    		 					...
		    		 					FacesContext.getCurrentInstance().getExternalContext().redirect
		    		 					("admissionDAcademicPet.xhtml?id="+dto.getId());	JavaScriptMessagesHandler.RegisterNotificationMessage(null, "Reverted successfully");
		    		    			sendRevertemail();
		...
		public void sendRevertemail(){
			try{
				...
				String email="Kindly be informed that, your Academic Petition With id:"+getDetailedDTO().getId()+" has been reverted by "+
			getInsDataFacade.getInsByPersonMail(authentication.getName()).getName()+".kindly check the petition on LTS system.<br/>The comment for the reverting is below: <br/><br/><b>( ";
				...
				SendMailThread sendMailThread = new SendMailThread(
						sender, stundet.getNameInEng(),
						email+content+" )</b>", "Academic Petition - Revert");
				sendMailThread.start();
		...
		public void resendPetition(){
			...
			//Check that logged in student is the same student for the petition
			 Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
				if (!authentication.getPrincipal().equals("anonymousUser"))// logged in
				{
					if(getDetailedDTO().getStudentMail().equals(authentication.getName()))
					{
			try{
			...
			if(dto!=null)
			{
				String email="Kindly be informed that, the reverted Academic Petition With id:"+getDetailedDTO().getId()+" has been updated by the student"+
						",So kindly check the system to take the appropriate action on the petition";
							...
							SendMailThread sendMailThread = new SendMailThread(
									...
									email+"</b>", "Academic Petition-Revert-ID:"+getDetailedDTO().getId());
							sendMailThread.start();
							FacesContext.getCurrentInstance().getExternalContext().redirect
	...
	public IAcademicPetitionActionsFacade getFacade() {
		return facade;
	}
	public void setFacade(IAcademicPetitionActionsFacade facade) {
		this.facade = facade;
	}
	...
	public CoursePetitionDTO getDetailedDTO() {
		return detailedDTO;
	}
	public void setDetailedDTO(CoursePetitionDTO detailedDTO) {
	...
	public IAdmissionAdminAcademicPetFacade getAdminFacade() {
		return adminFacade;
	}
	public void setAdminFacade(IAdmissionAdminAcademicPetFacade adminFacade) {
	...
	public void setRevertedBefore(Boolean revertedBefore) {
	 ...
	 public void proceed()
	 {
			...
			{
			try {	CoursePetitionDTO dto=getDetailedDTO();
	    		dto.setStep(PetitionStepsEnum.UNDER_REVIEW);
