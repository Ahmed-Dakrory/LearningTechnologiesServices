 ...
 */
@Service
public class AdmissionDeptAddDropFormServiceImpl implements IAdmissionDeptAddDropFormService {
	...
	public List<DropAddFormDTO> getPendingFormsOfAdmissionDept() {
		...
		for(int i=0;i<allForms.size();i++)
		{
			...
			{
				if(allForms.get(i).getStep().equals(PetitionStepsEnum.ADMISSION_PROCESSING)||allForms.get(i).getStep().equals(PetitionStepsEnum.INSTRUCTOR))
					{
