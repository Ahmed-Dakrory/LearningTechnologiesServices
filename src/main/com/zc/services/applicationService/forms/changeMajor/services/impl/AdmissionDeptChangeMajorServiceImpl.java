 ...
 */
@Service
public class AdmissionDeptChangeMajorServiceImpl implements IAdmissionDeptChangeMajorService {
	...
	public List<ChangeMajorDTO> getPendingPetitionsOfstuent() {
		...
		for(int i=0;i<allForms.size();i++)
		{
			...
			{
				if(allForms.get(i).getStep().equals(PetitionStepsEnum.ADMISSION_DEPT)||allForms.get(i).getStep().equals(PetitionStepsEnum.UNDER_PROCESSING))
				{
