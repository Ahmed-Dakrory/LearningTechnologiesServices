...
public class ScheduleRepositoryImpl implements ScheduleRepository{
	...
	public List<Schedule> getByCourseId(int id) {
		 Query query 	=sessionFactory.getCurrentSession().getNamedQuery("Schedule.getByCourseId").setInteger("id",id);

		 @SuppressWarnings("unchecked")
		List<Schedule> results=query.list();
		   return results;
	}
	...
	public List<Schedule> getAll() {
				 Query query 	=sessionFactory.getCurrentSession().getNamedQuery("Schedule.getAll");
	...
	@Override
	public boolean delete(Schedule note) {
	...
	public Schedule getById(int id) {
		// TODO Auto-generated method stub
		 Query query 	=sessionFactory.getCurrentSession().getNamedQuery("Schedule.getById").setInteger("id",id);
