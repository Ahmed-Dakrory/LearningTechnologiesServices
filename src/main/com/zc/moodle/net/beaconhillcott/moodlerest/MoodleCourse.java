...
public class MoodleCourse {
    ...
    private int summaryformat=SUMMARY_FORMAT_NO;
    private String format=FORMAT_TOPICS;
    private int showgrades=SHOW_GRADES_YES;
    private int newsitems=1;
    private int numsections=1;
    private long maxbytes=0;
    private int showreports=SHOW_REPORTS_NO;
    private int hiddensections=HIDDEN_SECTIONS_COLLAPSED;
    private int groupmode=GROUP_MODE_NO_GROUPS;
    private int groupmodeforce=GROUP_MODE_FORCE_NO;
    ...
    private long categorysortorder=-1;
    ...
    public void setMoodleCourseField(String nodeName, String content) {
        ...
        if (nodeName.equals("categorysortorder")) setCategorySortOrder(Long.parseLong(content.trim()));
        ...
        if (nodeName.equals("hiddensections")) setHiddenSections(Integer.parseInt(content));
