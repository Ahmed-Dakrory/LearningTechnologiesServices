...
@NamedQueries({
	...
	query = "from course_clo d where d.year = :year and d.semestar = :semestar"
			)
	,
	@NamedQuery(name="course_clo.getAllByYearAndSemestarAndCourseCode",
	query = "from course_clo d where d.year = :year and d.semestar = :semestar and d.course_code = :course_code"
			)
